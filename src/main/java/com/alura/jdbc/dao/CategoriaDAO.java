...
public class CategoriaDAO {
	...
	public List<Categoria> listar() {
		...
		try {
			final PreparedStatement prepareStatement = con.prepareStatement("SELECT id,nombre FROM categoria");
	...
	public List<Categoria> listarConProductos() {
		...
		try {
			final PreparedStatement prepareStatement = con.prepareStatement("SELECT C.ID, C.NOMBRE ,P.ID, P.NOMBRE, P.CANTIDAD "
					+ "FROM CATEGORIA C "
